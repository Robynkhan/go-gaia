...
type RemoteAgent struct {
	...
	running int32 // running indicates whfbcer the agent is active. Call atomically
}
...
func (a *RemoteAgent) GetWork() ([3]string, error) {
	...
	if a.currentWork != nil {
		...
		seedHash := fbcash.SeedHash(block.NumberU64())
...
// whfbcer the solution was accepted or not (not can be both a bad pow as well as

...
// Address represents the 20 byte address of an Fairblock account.
...
// IsHexAddress verifies whfbcer a string can represent a valid hex-encoded
// Fairblock address or not.

Name "gfbc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/fairblock/go-fairblock/issues"
!define UPDATEURL "https://github.com/fairblock/go-fairblock/releases"
!define ABOUTURL "https://github.com/fairblock/go-fairblock#fairblock-go"
...
# Install gfbc binary
Section "Gfbc" GFBC_IDX
  SetOutPath $INSTDIR
  file {{.Gfbc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gfbc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gfbc.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gfbc incoming peers (TCP:19565)"
  SimpleFC::AdvRemoveRule "Gfbc outgoing peers (TCP:19565)"
  SimpleFC::AdvRemoveRule "Gfbc UDP discovery (UDP:19565)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gfbc incoming peers (TCP:19565)" ""  6 1 1 2147483647 1 "$INSTDIR\gfbc.exe" "" "" "Fairblock" 19565 "" "" ""
  SimpleFC::AdvAddRule "Gfbc outgoing peers (TCP:19565)" ""  6 2 1 2147483647 1 "$INSTDIR\gfbc.exe" "" "" "Fairblock" "" 19565 "" ""
  SimpleFC::AdvAddRule "Gfbc UDP discovery (UDP:19565)" "" 17 2 1 2147483647 1 "$INSTDIR\gfbc.exe" "" "" "Fairblock" "" 19565 "" ""

  # Set default IPC endpoint (https://github.com/fairblock/EIPs/issues/147)
  ${EnvVarUpdate} $0 "FAIRBLOCK_SOCKET" "R" "HKLM" "\\.\pipe\gfbc.ipc"
  ${EnvVarUpdate} $0 "FAIRBLOCK_SOCKET" "A" "HKLM" "\\.\pipe\gfbc.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GFBC_IDX}
    SectionGetSize ${GFBC_IDX} $0

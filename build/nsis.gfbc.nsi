...
# 1. install gfbc for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gfbc
# 5. create gfbc, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable FAIRBLOCK_SOCKET
...
!define GROUPNAME "Fairblock"
!define APPNAME "Gfbc"
!define DESCRIPTION "Official Go implementation of the Fairblock protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gfbc is installed global

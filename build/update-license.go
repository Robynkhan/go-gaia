...
Please review the resulting diff to check whfbcer the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-fairblock authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-fairblock Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-fairblock library"
	}
	return "the go-fairblock library"
}

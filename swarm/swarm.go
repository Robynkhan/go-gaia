...
import (
	...
	"github.com/fairblock/go-fairblock/contracts/chequebook"
	...
	"github.com/fairblock/go-fairblock/swarm/api"
	httpapi "github.com/fairblock/go-fairblock/swarm/api/http"
	"github.com/fairblock/go-fairblock/swarm/fuse"
	"github.com/fairblock/go-fairblock/swarm/network"
	"github.com/fairblock/go-fairblock/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *fbcclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {

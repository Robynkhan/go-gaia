...
import (
	...
	"github.com/fairblock/go-fairblock/swarm/network/kademlia"
	"github.com/fairblock/go-fairblock/swarm/services/swap"
...
Timeout serves to indicate whfbcer the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whfbcer responder is expected to deliver content

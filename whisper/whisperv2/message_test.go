...
// Tests whfbcer a message can be wrapped without any identity or encryption.
...
// Tests whfbcer a message can be signed, and wrapped in plain-text.
...
// Tests whfbcer a message can be encrypted and decrypted using an anonymous
...
// Tests whfbcer a message can be properly signed and encrypted.

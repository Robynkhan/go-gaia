...
import (
	...
	"github.com/fairblock/go-fairblock/crypto/ecies"
	"github.com/fairblock/go-fairblock/event/filter"
...
// Whisper represents a dark communication interface through the Fairblock
...
type Whisper struct {
	...
	expirations map[uint32]*set.SetNonTS  // Message expiration pool (TODO: somfbcing lighter)
...
// New creates a Whisper client ready to communicate through the Fairblock P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),

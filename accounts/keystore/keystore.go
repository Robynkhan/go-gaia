...
// See https://github.com/fairblock/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whfbcer the event notification loop is running
...
// HasAddress reports whfbcer a key with the given address is present.
...
// ImportPreSaleKey decrypts the given Fairblock presale wallet and stores

...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/fairblock/pyfbcsaletool

		pyfbcsaletool generates the encryption key from password by
	...
	*/
	...
	fbcPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(fbcPriv)
	...
	expectedAddr := preSaleKeyStruct.FbcAddr

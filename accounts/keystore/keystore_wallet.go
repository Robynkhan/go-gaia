...
// Status implements accounts.Wallet, returning whfbcer the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain fairblock.ChainStateReader) {}

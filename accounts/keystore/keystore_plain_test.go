...
func tmpKeyStoreIface(t *testing.T, encrypted bool) (dir string, ks keyStore) {
	d, err := ioutil.TempDir("", "gfbc-keystore-test")
	if err != nil {
		t.Fatal(err)
	}
	if encrypted {
...
// Test and utils for the key store tests in the Fairblock JSON tests;

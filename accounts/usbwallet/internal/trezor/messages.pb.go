...
const (
	...
	MessageType_MessageType_FairblockGetAddress       MessageType = 56
	MessageType_MessageType_FairblockAddress          MessageType = 57
	MessageType_MessageType_FairblockSignTx           MessageType = 58
	MessageType_MessageType_FairblockTxRequest        MessageType = 59
	MessageType_MessageType_FairblockTxAck            MessageType = 60
	...
	MessageType_MessageType_FairblockSignMessage      MessageType = 64
	MessageType_MessageType_FairblockVerifyMessage    MessageType = 65
	MessageType_MessageType_FairblockMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_FairblockGetAddress",
	57:  "MessageType_FairblockAddress",
	58:  "MessageType_FairblockSignTx",
	59:  "MessageType_FairblockTxRequest",
	60:  "MessageType_FairblockTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_FairblockSignMessage",
	65:  "MessageType_FairblockVerifyMessage",
	66:  "MessageType_FairblockMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_FairblockGetAddress":       56,
	"MessageType_FairblockAddress":          57,
	"MessageType_FairblockSignTx":           58,
	"MessageType_FairblockTxRequest":        59,
	"MessageType_FairblockTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_FairblockSignMessage":      64,
	"MessageType_FairblockVerifyMessage":    65,
	"MessageType_FairblockMessageSignature": 66,
...
// *
// Request: Ask device for Fairblock address corresponding to address_n path
// @next PassphraseRequest
// @next FairblockAddress
// @next Failure
type FairblockGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *FairblockGetAddress) Reset()                    { *m = FairblockGetAddress{} }
func (m *FairblockGetAddress) String() string            { return proto.CompactTextString(m) }
func (*FairblockGetAddress) ProtoMessage()               {}
func (*FairblockGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *FairblockGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *FairblockGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Fairblock address derived from device private seed
// @prev FairblockGetAddress
type FairblockAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *FairblockAddress) Reset()                    { *m = FairblockAddress{} }
func (m *FairblockAddress) String() string            { return proto.CompactTextString(m) }
func (*FairblockAddress) ProtoMessage()               {}
func (*FairblockAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *FairblockAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next FairblockTxRequest
// @next Failure
type FairblockSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *FairblockSignTx) Reset()                    { *m = FairblockSignTx{} }
func (m *FairblockSignTx) String() string            { return proto.CompactTextString(m) }
func (*FairblockSignTx) ProtoMessage()               {}
func (*FairblockSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *FairblockSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *FairblockSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *FairblockSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *FairblockSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *FairblockSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *FairblockSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *FairblockSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *FairblockSignTx) GetDataLength() uint32 {
...
func (m *FairblockSignTx) GetChainId() uint32 {
...
// @prev FairblockSignTx
// @next FairblockTxAck
type FairblockTxRequest struct {
...
func (m *FairblockTxRequest) Reset()                    { *m = FairblockTxRequest{} }
func (m *FairblockTxRequest) String() string            { return proto.CompactTextString(m) }
func (*FairblockTxRequest) ProtoMessage()               {}
func (*FairblockTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *FairblockTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *FairblockTxRequest) GetSignatureV() uint32 {
...
func (m *FairblockTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *FairblockTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev FairblockTxRequest
// @next FairblockTxRequest
type FairblockTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *FairblockTxAck) Reset()                    { *m = FairblockTxAck{} }
func (m *FairblockTxAck) String() string            { return proto.CompactTextString(m) }
func (*FairblockTxAck) ProtoMessage()               {}
func (*FairblockTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *FairblockTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next FairblockMessageSignature
// @next Failure
type FairblockSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *FairblockSignMessage) Reset()                    { *m = FairblockSignMessage{} }
func (m *FairblockSignMessage) String() string            { return proto.CompactTextString(m) }
func (*FairblockSignMessage) ProtoMessage()               {}
func (*FairblockSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *FairblockSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *FairblockSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type FairblockVerifyMessage struct {
...
func (m *FairblockVerifyMessage) Reset()                    { *m = FairblockVerifyMessage{} }
func (m *FairblockVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*FairblockVerifyMessage) ProtoMessage()               {}
func (*FairblockVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *FairblockVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *FairblockVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *FairblockVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev FairblockSignMessage
type FairblockMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *FairblockMessageSignature) Reset()                    { *m = FairblockMessageSignature{} }
func (m *FairblockMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*FairblockMessageSignature) ProtoMessage()               {}
func (*FairblockMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *FairblockMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *FairblockMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*FairblockGetAddress)(nil), "FairblockGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*FairblockAddress)(nil), "FairblockAddress")
	...
	proto.RegisterType((*FairblockSignTx)(nil), "FairblockSignTx")
	proto.RegisterType((*FairblockTxRequest)(nil), "FairblockTxRequest")
	proto.RegisterType((*FairblockTxAck)(nil), "FairblockTxAck")
	proto.RegisterType((*FairblockSignMessage)(nil), "FairblockSignMessage")
	proto.RegisterType((*FairblockVerifyMessage)(nil), "FairblockVerifyMessage")
	proto.RegisterType((*FairblockMessageSignature)(nil), "FairblockMessageSignature")

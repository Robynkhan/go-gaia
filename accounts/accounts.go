...
// Package accounts implements high level Fairblock account management.
package accounts
...
// Account represents an Fairblock account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Fairblock account address derived from the key
...
type Wallet interface {
	...
	// Contains returns whfbcer an account is part of this particular wallet or not.
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain fairblock.ChainStateReader)

...
type ContractCaller interface {
	...
	// ContractCall executes an Fairblock contract call with the specified data as the
	// input.
	CallContract(ctx context.Context, call fairblock.CallMsg, blockNumber *big.Int) ([]byte, error)
}
...
type PendingContractCaller interface {
	...
	// PendingCallContract executes an Fairblock contract call against the pending state.
	PendingCallContract(ctx context.Context, call fairblock.CallMsg) ([]byte, error)
}
...
type ContractTransactor interface {
	...
	EstimateGas(ctx context.Context, call fairblock.CallMsg) (usedGas *big.Int, err error)

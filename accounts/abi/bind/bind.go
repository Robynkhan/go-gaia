...
// Package bind generates Fairblock contract Go bindings.
//
// Detailed usage document and tutorial available on the go-fairblock Wiki page:
// https://github.com/fairblock/go-fairblock/wiki/Native-DApps:-Go-bindings-to-Fairblock-contracts
package bind
...
// structured checks whfbcer a method has enough information to return a proper

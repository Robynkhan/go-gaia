...
// the `coin_type` 60' (or 0x8000003C) to Fairblock.
//
// The root path for Fairblock is m/44'/60'/0'/0 according to the specification
// from https://github.com/fairblock/EIPs/issues/84, albeit it's not set in stone
// yet whfbcer accounts should increment the last component or the children of

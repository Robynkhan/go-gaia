...
func newTestLDB() (*fbcdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "fbcdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := fbcdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db fbcdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db fbcdb.Database, t *testing.T) {
	const n = 8

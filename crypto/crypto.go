...
// Creates an fairblock address given the bytes and the nonce
...
// controls whfbcer the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whfbcer the signature values are valid with

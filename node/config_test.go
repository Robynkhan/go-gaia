...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gfbc.ipc", false, filepath.Join(os.TempDir(), "gfbc.ipc")},
		{"data", "gfbc.ipc", false, "data/gfbc.ipc"},
		{"data", "./gfbc.ipc", false, "./gfbc.ipc"},
		{"data", "/gfbc.ipc", false, "/gfbc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gfbc.ipc", true, `\\.\pipe\gfbc.ipc`},
		{"data", "gfbc.ipc", true, `\\.\pipe\gfbc.ipc`},
		{"data", `\\.\pipe\gfbc.ipc`, true, `\\.\pipe\gfbc.ipc`},
	}

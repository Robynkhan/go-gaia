...
// Contains reports whfbcer the given IP is contained in the list.
...
// IsLAN reports whfbcer an IP is a local network address.
...
// IsSpecialNetwork reports whfbcer an IP is located in a special-use network range
...
// CheckRelayIP reports whfbcer an IP relayed from the given sender IP

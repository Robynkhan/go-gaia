...
import (
	...
	"github.com/fairblock/go-fairblock/p2p/simulations/adapters"
)
...
// starting nodes and connecting them togfbcer.
//
...
// Connect connects two nodes togfbcer by calling the "admin_addPeer" RPC
...
type Node struct {
	...
	// Up tracks whfbcer or not the node is running
	Up bool `json:"up"`
}
...
type Conn struct {
	...
	// Up tracks whfbcer or not the connection is active
	Up bool `json:"up"`
...
// nodesUp returns whfbcer both nodes are currently up

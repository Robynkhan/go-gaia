...
import (
	...
	"github.com/fairblock/go-fairblock/crypto/secp256k1"
...
// and also verifies whfbcer the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whfbcer read packet had plain format.

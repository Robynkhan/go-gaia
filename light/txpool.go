...
// to the FBC network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whfbcer a transaction is valid according to the consensus rules.

...
// Package tests implements execution of Fairblock JSON tests.
package tests
...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(db, config, fbcash.NewShared(), vm.Config{})
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/* See https://github.com/fairblock/tests/wiki/Blockchain-Tests-II

   Whfbcer a block is valid or not is a bit subtle, it's defined by presence of

...
// information related to the Fairblock protocol such als blocks, transactions and logs.
...
// `fbc_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/fairblock/wiki/wiki/JSON-RPC#fbc_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with fbc_getFilterChanges.
//
// https://github.com/fairblock/wiki/wiki/JSON-RPC#fbc_newblockfilter
...
//
// https://github.com/fairblock/wiki/wiki/JSON-RPC#fbc_newfilter
...
//
// https://github.com/fairblock/wiki/wiki/JSON-RPC#fbc_getlogs
...
//
// https://github.com/fairblock/wiki/wiki/JSON-RPC#fbc_uninstallfilter
...
//
// https://github.com/fairblock/wiki/wiki/JSON-RPC#fbc_getfilterlogs
...
//
// https://github.com/fairblock/wiki/wiki/JSON-RPC#fbc_getfilterchanges

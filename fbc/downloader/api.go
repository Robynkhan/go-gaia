...
// Syncing provides information when this nodes starts synchronising with the Fairblock network and when it's finished.
...
type SyncingResult struct {
	...
	Status  fairblock.SyncProgress `json:"status"`
}

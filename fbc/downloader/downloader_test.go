...
type downloadTester struct {
	...
	stateDb fbcdb.Database // Database used by the tester for syncing from peers
	peerDb  fbcdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = fbcdb.NewMemDatabase()

...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (fbc/61) or header (fbc/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (fbc/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both fbc/61 and fbc/62)
}
...
func (f *Fetcher) insert(peer string, block *types.Block) {
	...
	go func() {
		...
		default:
			// Somfbcing went very wrong, drop the peer

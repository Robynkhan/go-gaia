...
// PeerInfo represents a short summary of the Fairblock sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Fairblock protocol version negotiated
...
// Handshake executes the fbc protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("fbc/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Fairblock sub-protocol.
type peerSet struct {

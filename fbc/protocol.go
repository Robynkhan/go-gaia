...
var ProtocolName = "fbc"

// Supported versions of the fbc protocol (first is primary).
var ProtocolVersions = []uint{fbc63, fbc62}
...
// fbc protocol message codes
const (
	// Protocol messages belonging to fbc/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to fbc/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10

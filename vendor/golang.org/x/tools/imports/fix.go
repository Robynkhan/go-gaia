...
// shouldTraverse reports whfbcer the symlink fi should, found in dir,
...
//
// The rename value tells goimports whfbcer to use the package name as
...
// pkgIsCandidate reports whfbcer pkg is a candidate for satisfying the
...
// canUse reports whfbcer the package in dir is usable from filename,
...
// fileInDir reports whfbcer the provided file path looks like

...
// SetCtrlCAborts sets whfbcer Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whfbcer line is auto-wrapped. The default is false (single line).
...
// whfbcer to retry the call to, or return the error returned by, readNext.

...
* `net/http`: [examples/nfbcttp/server.go](https://github.com/rs/cors/blob/master/examples/nfbcttp/server.go)
...
* **AllowCredentials** `bool`: Indicates whfbcer the request can include user credentials like cookies, HTTP authentication or client side SSL certificates. The default is `false`.

...
Go translates JavaScript-style regular expressions into somfbcing that is
...
difficult to provide somfbcing like these via Go, but you probably want to wrap

...
// togfbcer and stores the result in (x3, y3, z3).
...
func (curve *KoblitzCurve) splitK(k []byte) ([]byte, []byte, int, int) {
	...
	// At some point, it might be useful to write somfbcing similar to
...
func NAF(k []byte) ([]byte, []byte) {
	...
	// necessary.  Since we need to know whfbcer adding will cause a carry,
...
func initS256() {
	...
	// panics because it means somfbcing is wrong in the source code.

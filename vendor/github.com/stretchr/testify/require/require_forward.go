...
//
// Returns whfbcer the assertion was successful (true) or not (false).
...
//
// Returns whfbcer the assertion was successful (true, "error message %s", "formatted") or not (false).

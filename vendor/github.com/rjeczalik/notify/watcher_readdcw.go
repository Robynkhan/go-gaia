...
// in order to distinguish whfbcer current folder should be re-registered in
...
// watched is made in order to check whfbcer an action comes from a directory or
...
// gensys decides whfbcer the Windows action, system-independent event or both

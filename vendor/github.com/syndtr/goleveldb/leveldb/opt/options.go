...
type Options struct {
	...
	// ErrorIfExist defines whfbcer an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whfbcer an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whfbcer block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whfbcer to sync underlying writes from the OS buffer cache

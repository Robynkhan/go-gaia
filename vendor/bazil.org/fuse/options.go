...
// already exists, regardless of whfbcer O_EXCL was specified or not.
// To ensure this behavior, it normally sets OpenExclusive for all
// Create calls, regardless of whfbcer the original call had it set.
...
// them to the FUSE server. Without this, writfbcrough caching is
// used.

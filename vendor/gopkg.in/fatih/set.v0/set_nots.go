...
// IsEmpty reports whfbcer the Set is empty.
func (s *set) IsEmpty() bool {
	return s.Size() == 0
}

// IsEqual test whfbcer s and t are the same in size and have the same items.
...
// IsSubset tests whfbcer t is a subset of s.
...
// IsSuperset tests whfbcer t is a superset of s.

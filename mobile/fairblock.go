...
// Contains all the wrappers from the go-fairblock root package.
...
// the Fairblock network.
type SyncProgress struct {
	progress fairblock.SyncProgress
}

...
func (w *wizard) makeGenesis() {
	...
	fmt.Println(" 1. Fbcash - proof-of-work")
	fmt.Println(" 2. Clique - proof-of-authority")

	choice := w.read()
	switch {
	case choice == "1":
		// In case of fbcash, we're pretty much done
		genesis.Config.Fbcash = new(params.FbcashConfig)
...
func (w *wizard) manageGenesis() {
	// Figure out whfbcer to modify or export the genesis
	fmt.Println()

...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllFbcashProtocolChanges, new: AllFbcashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllFbcashProtocolChanges, new: AllFbcashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllFbcashProtocolChanges,

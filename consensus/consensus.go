...
// Package consensus implements different Fairblock consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the Fairblock address of the account that minted the given
	// block, which may be different from the header's coinbase if a consensus
	// engine is based on signatures.
	Author(header *types.Header) (common.Address, error)

	// VerifyHeader checks whfbcer a header conforms to the consensus rules of a
	...
	// VerifySeal checks whfbcer the crypto seal on a header is valid according to

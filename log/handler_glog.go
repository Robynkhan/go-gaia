...
type GlogHandler struct {
	...
	override  uint32 // Flag whfbcer overrides are used, atomically accessible
	backtrace uint32 // Flag whfbcer backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whfbcer this is the callsite

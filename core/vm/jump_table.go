...
type operation struct {
	...
	halts   bool // indicates whfbcer the operation should halt further execution
	jumps   bool // indicates whfbcer the program counter should not increment
	writes  bool // determines whfbcer this a state modifying operation
	valid   bool // indication whfbcer the retrieved operation is valid and known
	reverts bool // determines whfbcer the operation reverts state (implicitly halts)
	returns bool // determines whfbcer the operations sets the return data content
}

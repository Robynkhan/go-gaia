...
type Context struct {
	// CanTransfer returns whfbcer the account contains
	// sufficient fairblock to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers fairblock from one account to the other
...
// EVM is the Fairblock Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) fairblock virtual machine
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	// check whfbcer the max code size has been exceeded

...
// Package types contains data types related to Fairblock consensus.
package types
...
// Header represents a block header in the Fairblock blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) togfbcer.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the Fairblock blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package fbc to track
...
// [deprecated by fbc/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for fbc protocol, etc.
...
// DecodeRLP decodes the Fairblock
...
// EncodeRLP serializes b into the Fairblock RLP block format.

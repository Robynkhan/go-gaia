...
type TxPoolConfig struct {
	NoLocals  bool          // Whfbcer local transaction handling should be disabled
...
// validateTx checks whfbcer a transaction is valid according to the consensus
...
func (pool *TxPool) addTxsLocked(txs []*types.Transaction, local bool) []error {
	...
	// Only reprocess the internal state if somfbcing was actually added
	if len(dirty) > 0 {

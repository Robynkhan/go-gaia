...
func SetupGenesisBlock(db fbcdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	if genesis != nil && genesis.Config == nil {
		return params.AllFbcashProtocolChanges, common.Hash{}, errGenesisNoConfig
	}
	...
	// Check whfbcer the genesis block is already written.
	if genesis != nil {
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	default:
		return params.AllFbcashProtocolChanges
	}
}
...
func (g *Genesis) Commit(db fbcdb.Database) (*types.Block, error) {
	...
	config := g.Config
	if config == nil {
		config = params.AllFbcashProtocolChanges
	}
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db fbcdb.Database) *types.Block {
...
func GenesisBlockForTesting(db fbcdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Fairblock main net genesis block.
...
// DeveloperGenesisBlock returns the 'gfbc --dev' genesis block. Note, this must
// be seeded with the

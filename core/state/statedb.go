...
// Package state provides a caching layer atop the Fairblock state trie.
package state
...
// StateDBs within the fairblock protocol are used to store anything
...
// Exist reports whfbcer the given account address exists in the state.
// Notably this also returns true for suicided accounts.
func (self *StateDB) Exist(addr common.Address) bool {
	return self.getStateObject(addr) != nil
}

// Empty returns whfbcer the state object is either non-existent
...
//
// Carrying over the balance ensures that Fairblock doesn't disappear.

...
func makeTestState() (Database, *fbcdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := fbcdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db fbcdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db fbcdb.Database, root common.Hash) error {
...
func checkStateConsistency(db fbcdb.Database, root common.Hash) error {

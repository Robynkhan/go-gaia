...
type accessTestFn func(db fbcdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db fbcdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db fbcdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db fbcdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db fbcdb.Database, bhash common.Hash, number uint64) light.OdrRequest {

...
var (
	/*	propTxnInPacketsMeter     = metrics.NewMeter("fbc/prop/txns/in/packets")
		...
		reqHashInPacketsMeter     = metrics.NewMeter("fbc/req/hashes/in/packets")
		reqHashInTrafficMeter     = metrics.NewMeter("fbc/req/hashes/in/traffic")
		reqHashOutPacketsMeter    = metrics.NewMeter("fbc/req/hashes/out/packets")
		reqHashOutTrafficMeter    = metrics.NewMeter("fbc/req/hashes/out/traffic")
		reqBlockInPacketsMeter    = metrics.NewMeter("fbc/req/blocks/in/packets")
		reqBlockInTrafficMeter    = metrics.NewMeter("fbc/req/blocks/in/traffic")
		reqBlockOutPacketsMeter   = metrics.NewMeter("fbc/req/blocks/out/packets")
		reqBlockOutTrafficMeter   = metrics.NewMeter("fbc/req/blocks/out/traffic")

...
// ReleaseOracle is an Fairblock contract to store the current and previous
// versions of the go-fairblock implementation. Its goal is to allow Gfbc to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Gfbc releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Gfbc release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an Fairblock user, either

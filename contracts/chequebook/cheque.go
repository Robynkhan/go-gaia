...
// Package chequebook package wraps the 'chequebook' Fairblock smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in fairblock; (auto)cashing cheques in fairblock
// as well as (auto)depositing fairblock to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/fairblock/go-fairblock/contracts/chequebook/contract"
	...
	"github.com/fairblock/go-fairblock/swarm/services/swap/swap"
)
...
// * depositing fairblock to the chequebook
// * watching incoming fairblock
...
// Cash cashes the cheque by sending an Fairblock transaction.
